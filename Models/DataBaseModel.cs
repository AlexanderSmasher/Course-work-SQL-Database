...
namespace DBRealEstateAgency.Models
{
    class DataBaseModel
    {
        ...
        private static MySqlConnection connection = new MySqlConnection("server=localhost;port=3306;username=" + UserModel.login + ";password=" + UserModel.password + ";database=RealEstateAgency");
